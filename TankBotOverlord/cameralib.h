...
public:
    ...
    /*******************************************************************************
     * Function Name  : VC0706::get_version
    ...
    /*******************************************************************************
     * Function Name  : VC0706::tv_out_control
     ...
     * Return         : None
     *******************************************************************************/
    void tv_out_control(int on);

    /*******************************************************************************
     * Function Name  : VC0706::osd_add_char
     ...
     * Return         : None
     *******************************************************************************/
    void osd_add_char(int col, int row, String osd_string);

    /*******************************************************************************
     * Function Name  : VC0706::w_h_downsize
     ...
     * Return         : None
     *******************************************************************************/
    void w_h_downsize(int scale_width, int scale_height);

    /*******************************************************************************
     * Function Name  : VC0706::read_frame_buffer
     ...
     * Return         : None
     *******************************************************************************/
    void read_frame_buffer(unsigned long buffer_address, unsigned long buffer_length);

    /*******************************************************************************
     * Function Name  : VC0706::frame_control
     ...
     * Return         : None
     *******************************************************************************/
    void frame_control(byte frame_control);

    /*******************************************************************************
     * Function Name  : VC0706::motion_detection
     ...
     * Return         : None
     *******************************************************************************/
    void motion_detection(int control_flag);

    /*******************************************************************************
     * Function Name  : VC0706::motion_control
     ...
     * Return         : None
     *******************************************************************************/
    void motion_control(int control_flag);

    /*******************************************************************************
     * Function Name  : VC0706::get_framebuffer_length
     ...
     * Return         : None
     *******************************************************************************/
    void get_framebuffer_length(byte fbuf_type);

    /*******************************************************************************
     * Function Name  : VC0706::uart_power_save
     ...
     * Return         : None
     *******************************************************************************/
    void uart_power_save(byte power_save_on);

    /*******************************************************************************
     * Function Name  : VC0706::uart_color_control
     * Description    : stop current frame for reading
     *
     ...
     * Return         : None
     *******************************************************************************/
    void uart_color_control(byte show_mode);

    /*******************************************************************************
     * Function Name  : VC0706::compression_ratio
     * Description	  : stop current frame for reading
     *
     ...
     * Return		  : None
     *******************************************************************************/
    void compression_ratio(int ratio);

    /*******************************************************************************
     * Function Name  : VC0706::motion_windows_setting
     ...
     * Return		  : None
     *******************************************************************************/
    void motion_windows_setting(unsigned int register_address, unsigned long data);
